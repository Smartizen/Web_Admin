...
import { setSmartizenDeviceType } from 'store/actions';
...
export default function SmartizenDeviceType() {
  ...
  const getDevice = async () => {
    let data = await axiosClient.get('/device-type/smartizen');
    console.log({ data });
    setData(data);
    dispatch(setSmartizenDeviceType(data));
  };
  ...
  const addDeviceType = async () => {
    await axiosClient.post('/device-type/smartizen', {
      typeId,
